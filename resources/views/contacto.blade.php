<x-app-layout>
    <x-slot name="header">
        <h1 class="text-center">Recibe asesoria de un experto</h1>
    </x-slot>
    <div>
        <p class="lead text-center">Eureka E-Learning Easy es una empresa especializada en el desarrollo de programas educativos para alumnos de educacion preescolar desde 2020.</p>
    </div>
